...
const transactionStatus_1 = require("../../ts-model/enum/transactionStatus");
...
__decorate([
    (0, class_validator_1.IsEnum)(transactionStatus_1.transactionStatus, { message: 'status must be enum transactionStatus' }),
    __metadata("design:type", String)
], transactionHistory.prototype, "status", void 0);
__decorate([
    (0, class_validator_1.IsString)({ message: 'data must be a string' }),
    __metadata("design:type", String)
