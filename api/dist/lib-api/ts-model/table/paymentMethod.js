...
const paymentMethodTypes_1 = require("../../ts-model/enum/paymentMethodTypes");
...
__decorate([
    (0, class_validator_1.IsEnum)(paymentMethodTypes_1.paymentMethodTypes, { message: 'jenis must be enum paymentMethodTypes' }),
    __metadata("design:type", String)
], paymentMethod.prototype, "jenis", void 0);
__decorate([
    (0, class_validator_1.IsString)({ message: 'kode must be a string' }),
    __metadata("design:type", String)
